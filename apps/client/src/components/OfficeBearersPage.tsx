...
interface OfficeBearersPageProps {
  onNavigate?: (page: string) => void;
}

export function OfficeBearersPage({
  onNavigate,
}: OfficeBearersPageProps) {
  ...
  const executives: ExecutiveMember[] = [
    ...
    },
    {
      ...
      institution: "Dr. Manmohan Singh Bengaluru City University, Bangalore",
      qualifications: "Ph.D, MBA, DCSE, SCDM-P, MISTE, IRDA, GSTP",
      email: "nabi.a@ktpoa.org",
      about:
        "Prof. Dr. NABI.A, having 25+ years professional experience serving to higher educational institutions in India, worked in various designations like Placement Officer, Head-T&P,           Dy. Director, Professor, HOD & Registrar, College Principal & Director, presently working as Professor & Placement Professional @ Dr. MS Bengaluru City University, Bengaluru. A blend experience in all the levels of higher education industry (Engg., Dental, Medical, Nursing, Science & Etc.)",
      areasOfExpertise: [
        "Campus Recruitments", "Corporate Relationships", "Technical Hiring (Freshers & Lateral)", "Teaching & Learning Development", "College Administration and Compliances like (NAAC, NBA, UGC, AICTE, NIRF, GOVT. Approvals & Affiliations)", "Training and Liaoning", "Career Counselling", "Employability training", "Gap filling Industry – Academia", "Talent Nurturing", "Building & Acquisition", "Industry Collaborations", "Strategy Planning & implementation", "High volume business Consulting", "Insurance& Income Tax & GST Comply. ", "Employability Training Stakeholder & Corporate Relationship Management"
      ],
      keyAchievements: [
        "Established 40+ Centre of Excellence for various companies namely CISCO, IBM, Sonata, Mahindra & Mahindra, Mahindra Aerospace, Applied S&I, PCS Tech, SmartBrains and etc...",
        "Facilitated for training and placement activates more than 100+ higher educational institution students by connecting with their top level management/officials.", 
        "Currently working with 6 stipend-based internships and hiring for 8 different companies to cater the need of the University placements.",
        "Arranged more than 400+ campus recruitment drives.",
        "Organized 24 Mega job fairs in last 5 years (ranging from 10 companies to 102 and 1000 candidates to 13,000 candidates under one roof.)",
        "Organized 100+ pool drives across VTU colleges and BU, BCU, BNU, RGUHS colleges.",
        "Excellent network connects with corporates & Member in various HR forums.",
        "Arranged 100+ internship programs for students.",
        "6 industrial projects brought to the institution.",
        "Arranged coordinated Trainings on GATE, soft skills, aptitude, technical and etc...",
        "Member in VTU Empower 10000 Programme initiated by VTU, Belgaum.",
      ...
      <section className="h-[50vh] min-h-[500px] bg-gradient-to-br from-[hsl(var(--navy))] via-[hsl(var(--navy))]/95 to-[hsl(var(--navy))]/90 relative overflow-hidden">
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 text-white/60 text-sm animate-bounce">
          <div className="flex flex-col items-center gap-2">
            <span className="text-xs">Office Bearers</span>
